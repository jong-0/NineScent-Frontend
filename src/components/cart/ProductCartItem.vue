<template>
  <div
    class="product-item d-block d-md-flex align-items-center position-relative"
  >
    <!-- 체크박스 -->
    ...
    <!-- 총 금액 영역 -->
    <div
      class="price-area ms-3 flex-grow-1 text-end position-relative"
    >
      <!-- 삭제 버튼 (금액 위쪽) -->
      <button
        class="delete-button"
...
const formattedDiscount = computed(() =>
  (props.discount * props.quantity).toLocaleString()
);
